...
exports.addUserToTourney = async (req, res) => {
    ...
    try {
        ...
        const userTourney = await UsersTourneys.create({ userId, tourneyId, teamId: null, tourneyRole: 'guest' });
...
exports.assignTeamToUser = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ message: 'Équipe assignée à l\'utilisateur avec succès.', userTourney });
    } catch (error) {
...
exports.removeUserFromTourney = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({ message: 'Erreur serveur lors de la suppression de l’utilisateur du tournoi.' });
    }
};
...
exports.getUsersByTourney = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({ message: 'Erreur serveur lors de la récupération des utilisateurs.', error });
    }
};
...
exports.getUnassignedUsersByTourney = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({ message: 'Erreur serveur lors de la récupération des utilisateurs non assignés.', error });
    }
};
