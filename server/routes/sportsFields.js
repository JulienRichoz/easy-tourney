...
router.put('/:sportsFieldsId', isAuthenticated, isAdmin, updateSportsFields); // Mettre à jour une association sport/terrain (admin uniquement)
router.delete('/:sportsFieldsId', isAuthenticated, isAdmin, deleteSportsFields); // Supprimer une association sport/terrain (admin uniquement)
