...
const { generateInviteToken, getAllInviteTokens, getInviteToken, invalidateInviteToken, validateInviteToken, invalidateAllInviteTokens, validateAllInviteTokens } = require('../controllers/inviteTokenController');
