...
const { isAuthenticated, authorizeTournamentAccess } = require('../middlewares');
...
router.get('/', isAuthenticated, authorizeTournamentAccess, getGameEventsByGame); // Récupérer les événements d'un match
