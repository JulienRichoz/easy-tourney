    ...
    methods: {
        ...
        new Draggable(containerEl, {
          ...
          eventData(eventEl) {
            return {
              ...
              extendedProps: {
                sportId: eventEl.getAttribute('data-id'), // Assurez-vous que data-id est correct
              },
            };
          },
        });
      ...
      getFieldCalendarOptions(field) {
        return {
          ...
          eventDrop: (info) => this.handleEventDrop(info, field.id), // Gestion du déplacement des événements
          eventResize: (info) => this.handleEventResize(info, field.id), // Gestion du redimensionnement des événements
      ...
      async handleEventResize({ event, fieldId }) {
        ...
        console.log(
          'Événement redimensionné, mise à jour :',
          updatedEvent,
          fieldId
        );
